...
- **V-048** · 2026-08-18 — **Every API error this app returns is
  ...
  *every* `HTTPException` as `{"error": {"code", "message", "details",
  ...
  (Filed as `V-046` under #3831; renumbered on the #3835 merge because #3837's
  entry — the one V-027 and `workflow_script_guard.py` cite by ID — took
  `V-046` first. IDs are never reused.)
