...
- **D-034** · 2026-08-19 · developer agent (#3950) — **"Dev mode on a cloud
  ...
  runtime data.
  (Allocated D-033 from `ledger_ids.py`; renumbered to D-034 when the merge
  from v3.0.0 showed #3867 had taken that number first. IDs are never reused
