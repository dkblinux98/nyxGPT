...
- **D-035** · 2026-08-19 · owner (#3948) — **`--local` is the default locality
  ...
  Filed as **D-033** on this branch and renumbered twice on the way into
  `v3.0.0` — #3867 had taken `D-033` and #3811 then took `D-034`, each while
  this PR was in review. IDs are never reused.
