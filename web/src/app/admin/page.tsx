          ...
          {steps.map((step, idx) => (
            <div
              ...
              style={{
                flex: 1,
                height: 4,
                background: idx <= currentStepIndex ? 'var(--primary)' : 'var(--muted)',
                borderRadius: 2,
              }}
            />
          ))}
          ...
          <div>
            ...
            <div style={{ marginTop: '1.5rem' }}>
              <button
                ...
                style={{
                  padding: '10px 20px',
                  background: testingConnection ? 'var(--muted)' : 'var(--primary)',
                  color: 'white',
                  border: 'none',
                  borderRadius: 6,
              ...
              {testResult && (
                <div
                  style={{
                    ...
                    border: `1px solid ${testResult.success ? 'var(--success)' : 'var(--error-text)'}`,
                  }}
                >
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          <button
            ...
            style={{
              padding: '10px 20px',
              background: currentStepIndex === 0 ? 'var(--muted)' : 'var(--background)',
