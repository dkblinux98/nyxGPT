  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 900, margin: '0 auto' }}>
      <div style={{ marginBottom: '2rem' }}>
        ...
        <a href="/" style={{ color: 'var(--success)', textDecoration: 'none' }}>
          ← Back to Chat
        </a>
      </div>
          ...
          {steps.map((step, idx) => (
            <div
              ...
              style={{
                flex: 1,
                height: 4,
                background: idx <= currentStepIndex ? 'var(--success)' : 'var(--muted)',
                borderRadius: 2,
              }}
            />
          ))}
        ...
        {currentStep === 'model' && (
          <div>
            ...
            <div style={{ padding: '1rem', background: 'var(--info-bg)', borderRadius: 6, fontSize: 14 }}>
              ...
              <a href="/models" style={{ color: 'var(--success)' }}>
                Models page
              </a>{' '}
          ...
          <div>
            ...
            <div style={{ marginTop: '1.5rem' }}>
              <button
                ...
                style={{
                  padding: '10px 20px',
                  background: testingConnection ? 'var(--muted)' : 'var(--success)',
                  color: 'white',
                  border: 'none',
                  borderRadius: 6,
