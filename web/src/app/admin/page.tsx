...
export default function AdminPage() {
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: 900, margin: '0 auto' }}>
          ...
          {steps.map((step, idx) => (
            <div
              ...
              style={{
                flex: 1,
                height: 4,
                background: idx <= currentStepIndex ? 'var(--primary)' : 'var(--border-inactive)',
                borderRadius: 2,
              }}
            />
          ))}
        ...
        {currentStep === 'model' && (
          <div>
            ...
            <div style={{ padding: '1rem', background: 'var(--info-bg)', borderRadius: 6, fontSize: 14 }}>
              ...
              <a href="/models" style={{ color: 'var(--primary)' }}>
                Models page
              </a>{' '}
          ...
          <div>
            ...
            <div style={{ marginTop: '1.5rem' }}>
              <button
                ...
                style={{
                  padding: '10px 20px',
                  background: testingConnection ? 'var(--primary-disabled)' : 'var(--primary)',
                  color: 'white',
                  border: 'none',
                  borderRadius: 6,
              ...
              {testResult && (
                <div
                  style={{
                    ...
                    border: `1px solid ${testResult.success ? 'var(--border-success)' : 'var(--border-error)'}`,
                  }}
                >
          ...
          <div>
            ...
            <div style={{ marginTop: '2rem' }}>
              <button
                ...
                style={{
                  padding: '12px 24px',
                  background: saving || !formData.default_model ? 'var(--primary-disabled)' : 'var(--button-success)',
                  color: 'white',
                  border: 'none',
                  borderRadius: 6,
      ...
      {/* Navigation */}
      <div style={{ marginTop: '2rem' }}>
        <div style={{ marginBottom: '0.5rem', textAlign: 'center', fontSize: 12, color: 'var(--text-muted)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          <button
            ...
            style={{
              padding: '10px 20px',
              background: currentStepIndex === 0 ? 'var(--primary-disabled)' : 'var(--muted)',
              color: currentStepIndex === 0 ? 'var(--text-disabled)' : 'var(--foreground)',
              border: '1px solid var(--border)',
              borderRadius: 6,
