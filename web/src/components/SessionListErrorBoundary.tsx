...
/**
 * Error Boundary for Session List operations
 *
 * Catches rendering errors and state update failures in optimistic update flows.
 * Provides graceful degradation instead of crashing the entire app.
 */
export class SessionListErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    console.error('SessionListErrorBoundary caught an error:', error, errorInfo);
