...
RAG on or off -- brings up the [observability
tier](#observability-in-the-cluster) and waits for its ten workloads to roll
out too, and snapshots Pod/Service health for all of them.
